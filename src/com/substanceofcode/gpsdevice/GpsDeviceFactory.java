...
public class GpsDeviceFactory {
     ...
     * @param address
     * @param alias
     * @return The selected Device, or null if other options prevent the chosen device from
     * being created. Eg jsr179 devices need explicit permission to run
     */
    public static Device createDevice(String address, String alias) {
        ...
        if ("internal".equals(address) ) {
            ...
            if( Controller.getController().getUseJsr179()){
