/*
 * LocalGeonamesGeocodeProvider.java
 *
 ...
 * @author kaspar
 */
public class LocalGeonamesGeocodeProvider implements GeocodeProvider
{

    public GeocodeRequest geocodePlace(PlaceDescription descr, GeocodeStatusCallback notify) {
        return new LocalGeonamesRequest(descr, notify);
    }

    public String getIdentifier() {
        return "localgeonames";
    }
