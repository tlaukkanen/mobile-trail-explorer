...
public class DisplaySettingsForm extends Form implements CommandListener {
	...
	public void commandAction(Command command, Displayable displayable) {
		if (command == okCommand) {
			...
			// Tell the controller if it should be running the 'backlightAlwaysOn' Thread
	...
	private void addControls() {
		...
		String[] backlight = { "Allow Off", "Force On" };
		backlightGroup = new ChoiceGroup("Phone Backlight", ChoiceGroup.EXCLUSIVE, backlight, null);
